package com.example.statechrome;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void signIn() {
        Uri redirectUri = Uri.parse("com.example.statechrome:/oauth2callback");
                ...
                new RetrieveConfigurationCallback() {
                    ...
                    public void onFetchConfigurationCompleted(
                        ...
                        AuthorizationRequest authRequest = new AuthorizationRequest.Builder(
                                config,
                                "883559688036-ubbhap5licgkrdhuk464s7r34ejil7ac.apps.googleusercontent.com",
