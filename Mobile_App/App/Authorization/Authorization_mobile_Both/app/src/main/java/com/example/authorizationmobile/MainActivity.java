package com.example.authorizationmobile;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void signIn() {
        Uri redirectUri = Uri.parse("com.example.authorizationmobile:/oauth2callback");
                ...
                new RetrieveConfigurationCallback() {
                    ...
                    public void onFetchConfigurationCompleted(
                        ...
                        AuthorizationRequest authRequest = new AuthorizationRequest.Builder(
                                config,
                                "883559688036-c2l82uocu2k6ahjr2nf76gf3errdfdnq.apps.googleusercontent.com",
