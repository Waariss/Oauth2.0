package com.example.authorizationmobileonlyauthcode;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void signIn() {
        Uri redirectUri = Uri.parse("com.example.authorizationmobileonlyauthcode:/oauth2callback");
                ...
                new RetrieveConfigurationCallback() {
                    ...
                    public void onFetchConfigurationCompleted(
                        ...
                        AuthorizationRequest authRequest = new AuthorizationRequest.Builder(
                                config,
                                "883559688036-8otbi3j5vkan5vhh4oqh7ebhf5b1lghu.apps.googleusercontent.com",
