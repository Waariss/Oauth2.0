...
public class MainActivity extends AppCompatActivity {
    ...
    private void startLogin() {
        Uri redirectUri = Uri.parse("com.example.myapplication:/oauth2redirect");
                ...
                new RetrieveConfigurationCallback() {
                    ...
                    public void onFetchConfigurationCompleted(
                        ...
                        AuthorizationRequest authRequest = new AuthorizationRequest.Builder(
                                config,
                                "534226493472-4oakstg7cmclehmspq6jjnt7ar2mervn.apps.googleusercontent.com", // Replace this with your client ID
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_SECOND_APP) {
            ...
            if (resp != null) {
                handleAuthorizationCode(resp.authorizationCode, resp.state);
            } else {
