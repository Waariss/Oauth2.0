  ...
  return (
    <Container className="d-flex align-items-center justify-content-center" style={{ minHeight: '100vh', background: '#ffffff' }}>
      <div className="text-center">
        <h3 className="my-3">Testing Authorization with OAuth2 using Auth Code and Nonce</h3>
...
const Login = () => {
  ...
  return (
    <Container className="d-flex align-items-center justify-content-center" style={{ minHeight: '100vh' }}>
      <div className="text-center">
        <h3 className="mb-4">Testing Authorization with OAuth2 using Auth Code and Nonce</h3>
        <div>
